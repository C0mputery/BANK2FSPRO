...
public partial class Decompiler {
    ...
    private string _eventMetadataDirectory = string.Empty;
    ...
    private string _snapshotMetadataDirectory = string.Empty;
    ...
    private void SetupDirectories() {
        ...
        _eventMetadataDirectory = Path.Combine(_metadataDirectory, "Event");
        ...
        _snapshotMetadataDirectory = Path.Combine(_metadataDirectory, "Snapshot");
        ...
        Directory.CreateDirectory(_eventMetadataDirectory);
        ...
        Directory.CreateDirectory(_snapshotMetadataDirectory);
